...
export declare function PlayerPDA(programId: TriviaProgram['programId'], trivia: PublicKey, user: PublicKey): Promise<PDA>;
export declare function AnswerPDA(programId: TriviaProgram['programId'], trivia: PublicKey, game: PublicKey, question: PublicKey, player: PublicKey): Promise<PDA>;
